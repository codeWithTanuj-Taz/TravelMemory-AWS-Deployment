...
Add the domain to Cloudflare and import the existing DNS records.

### Screenshot

*(Insert Cloudflare onboarding screenshot.)*
...
*(Insert GoDaddy nameserver configuration screenshot.)*
...
*(Insert Cloudflare DNS records screenshot.)*
...
<img width="680" height="564" alt="Screenshot 2026-07-11 153129" src="https://github.com/user-attachments/assets/d1f6c339-8d98-44ff-ae68-efda783fae89" />
